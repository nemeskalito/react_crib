...
const Counter = () => {
  ...
  return (
    <>
      ...
      <ul>
        <li>
          - <strong>Лего-кирпичики:</strong> Каждый кирпичик — это компонент. Ты
          можешь комбинировать их, чтобы строить более сложные конструкции.
        </li>
        <li>
      ...
      <h2>3.3. Иерархия</h2>
      <p>
        Компоненты могут быть вложенными: родительский компонент передаёт данные
        дочерним через props (разберем в следующей главе).
      </p>
      <pre>
